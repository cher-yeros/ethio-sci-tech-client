          ...
          <div class="col-xl-4">
            <div class="card">
              <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                />
                <h2 style={{ color: "#012970" }}>{user.name}</h2>
                <h3 style={{ color: "#0129708c" }}>{user.role}</h3>
                <div class="social-links mt-2">
                  <a href="#" class="twitter" style={{ color: "#012970" }}>
                    <i class="bi bi-twitter"></i>
                  </a>
                  <a href="#" class="facebook" style={{ color: "#012970" }}>
                    <i class="bi bi-facebook"></i>
                  </a>
                  <a href="#" class="instagram" style={{ color: "#012970" }}>
                    <i class="bi bi-instagram"></i>
                  </a>
                  <a href="#" class="linkedin" style={{ color: "#012970" }}>
